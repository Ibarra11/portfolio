      ...
      <div className="max-w-4xl mx-auto pt-9">
        ...
        <section className="mb-8">
          ...
          <ul className="flex flex-wrap gap-2">
            ...
            <li className=" bg-slate-200 p-2 rounded-lg">Next.js</li>
            <li className=" bg-slate-200 p-2 rounded-lg">TailwindCSS</li>
            <li className=" bg-slate-200 p-2 rounded-lg">Prisma</li>
            <li className=" bg-slate-200 p-2 rounded-lg">GraphQL</li>
        ...
        <section className="mb-8">
          ...
          <div className="mb-4">
            ...
            <div className="mb-2">
              ...
              <p className="text-base">
                ...
                development environment variable, which would result in the API
                call failing. To resolve this, I just determined whether or not
                the app was running in production or development and set a
                variable to it and the API calls would use this variable as the
                base to the api call.
              </p>
            </div>
            <div>
              <h4 className=" text-xl mb-2">Production Build</h4>
              <p className="text-base">
                ...
                running, so I can safely make API calls. This just bypassed the
                static generation constraints, which might not be the best
                approach. Alternatively, what I could of done is check the
                session on the page level with getServerSideProps, but I decided
                to check the session on the _app because I would only have to
                check in one place and with getServerSideProps I would have to
                check it in each page.
              </p>
            </div>
          </div>
          <div className="mb-4 ">
          ...
          <div className="mb-4">
            <h3 className=" text-2xl mb-3">Authentication</h3>
            <div className="mb-2">
              <h4 className="text-xl mb-2">Password Management</h4>
              <p className="text-base">
                ...
                have successfully signed up, I then create a session for the
                user using Iron-Session. This means that the user no longer has
                to sign in as long as their session is valid.
              </p>
            </div>
            <div>
              <h4 className="text-xl mb-2">Protected Routes</h4>
              <p className="text-base">
                ...
                session when the user visits one of these pages and if there is
                no session they get redirected to the login page. I am checking
                the session client side, which means there is a little flash of
                content that is shown to unaunthenticated users.
              </p>
            </div>
          </div>
        </section>
